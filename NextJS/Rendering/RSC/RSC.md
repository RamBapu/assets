...
- handles interactivity, application state logic using hooks, DOM apis like geolocation and localStorage
- for building UI & stateless 
### **Server components**
...
- stateful components - includes state
